...
class ConfirmAccountsPager extends ReverseChronologicalPager {
	...
	function getQueryInfo() {
		...
		$fields = [ 'acr_id', 'acr_name', 'acr_real_name', 'acr_registration', 'acr_held',
			...
			'acr_urls', 'acr_filename', 'acr_type', 'acr_rejected', 'acr_company', 'acr_receive_emails',
			'acr_receive_newsletter', 'acr_country', 'acr_city', 'acr_state', 'acr_prefix', 'acr_title',
			'acr_firstname', 'acr_lastname' ];
