		...
		if ( $wgConfirmAccountSaveInfo ) {
			...
			$dbw->insert( 'account_credentials',
				[
					...
					'acd_country' => $accReq->getCountry(),
					'acd_city' => $accReq->getCity(),
					'acd_state' => $accReq->getState(),
					'acd_prefix' => $accReq->getPrefix(),
					'acd_title' => $accReq->getTitle(),
					'acd_firstname' => $accReq->getFirstName(),
					'acd_lastname' => $accReq->getLastName(),
